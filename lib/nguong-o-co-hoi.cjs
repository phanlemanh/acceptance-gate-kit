...
// ném lỗi làm bộ quét/bản đồ chết; cờ LNT_AVAILABLE để bên đọc muốn nói ra thì nói.
let LNT = null;
try { LNT = require('./lop-nhin-thay.cjs'); } catch (_) { LNT = null; }
const LNT_AVAILABLE = !!LNT;
...
module.exports = { UAT_THRESHOLD_HEADING, SURFACE_NGUOI_DUNG, LNT_AVAILABLE, coNguoiDungCuoi, thresholdState, thresholdLabels, prefixes, prefixFromTemplate, isKhongDoLine, timeboxDate, quaTimebox, bulletOf, chuaDien, PLACEHOLDER_RE };
