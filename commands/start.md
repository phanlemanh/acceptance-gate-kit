...
3. **Trình MỘT thẻ, ba nhóm, đúng thứ tự ưu tiên:**
   ...
   **Kết thúc buổi khai thác — MỌI lối, mở bằng skill nào cũng vậy:** ghi
   ...
   ④ section «Vấn đề & ai gặp» ≥ 1 câu, MỞ bằng dòng `Gốc:` (khối `OPP-GOC-LINE`) — một con trỏ vào tầng dưới mà người đọc lần được trong mười giây; hình dạng cụ thể theo luật của kho đang chạy; chưa có neo thì ghi hạt giống, KHÔNG mở ô · ⑤ section «Ngưỡng chết / ngưỡng UAT»:
