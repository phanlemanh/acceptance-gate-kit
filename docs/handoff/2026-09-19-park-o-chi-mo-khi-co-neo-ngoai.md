...
## Tách 19/09 — luật đi trước, răng ở lại (owner đồng ý «cắt đuôi giữ lõi» lần cuối)

Sau park, owner duyệt tách vòng làm hai phần theo hạng rủi ro:

- **Đi `main` bằng PR tài liệu** (nhánh `docs/o-chi-mo-khi-co-neo-ngoai-luat`, không chạm
  engine, không chạm khuôn giao đi, không kéo hồ sơ đã ký nào vào diff): luật neo trong
  `CLAUDE.md` kèm giới hạn khai và ngưỡng mở lại · luật (b) mẫu số kho-nhận · vế «PHẢI gọi tên
  chỗ cắt» hạ xuống «được phép» · hàng chờ đã rà (ô có `Gốc:` giữ, ô không neo xếp lại, giữ
  chữ) · số đo · ba hạt giống · ô này ở trạng thái park cùng bàn giao này · 20 dòng sổ
  known-limits.
- **Ở lại nhánh này:** răng VC8 mới, lối (b) ghi hạt giống (LB1–LB3), khuôn ô/hợp đồng/`start.md`
  chỉ mang khái niệm, `config.yaml` hai executor, trọn hồ sơ vòng (hợp đồng, evals, sổ 28 dòng,
  run-log, báo cáo, spec, plan). Gộp lại khi ngưỡng trong `CLAUDE.md` nổ: ≥1 ô mới vào hàng chờ
  không có dòng `Gốc:`.

Phần dưới đây là bàn giao gốc lúc park, giữ nguyên.
