...
**Gốc:** `acceptance-gate-kit/_acceptance/o-chi-mo-khi-co-neo-ngoai` — lượt chấm 3 gọi tên
...
`hangCho` trong `tests/plugins/vao-co-o.test.mjs` định nghĩa hàng chờ Cổng Đáng là
