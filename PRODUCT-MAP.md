...
- lớp lỗi đo-lường thành luật ở 2 điểm cắm: gap-probe S1 (4 câu cross-check) + review lens measurement S4 (6 hình dạng, một chỗ, mutation-covered); không nới finder cũ (`matrix-measure-law`)
