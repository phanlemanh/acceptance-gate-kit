...
```mermaid
flowchart TD
  A["Đang cân nhắc cơ hội<br/>31 việc"] --> GD{"Cổng Đáng"}
...
- Phát hành kit 2.12.0 — đóng số cho cửa sổ 2.11→2.12, THUẦN CẮT SỐ. Hai vòng đã ký trong cửa sổ đưa 253 tiêu chí tới bốn kho tiêu thụ và đóng cửa veto sau chữ ký. (`release-2-12-0`)
...
- Mã sổ quyết định duy nhất — khuôn mã d-<UTC>-<n> ở bên ghi, khoá overlay theo dòng ở bên đọc để thẻ không lặp một câu dịch lên mọi dòng chung mã (`ma-so-quyet-dinh-duy-nhat`) — đã giao — máy thông, cửa veto còn mở
