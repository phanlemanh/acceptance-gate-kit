...
- Hồ sơ làn V không phải «chờ ký» — máy quét vào phiên và bản đồ đọc cùng luật với lưới trước-merge: V-mở + PASS + T2 ⇒ đã giao, cửa veto mở (`lan-v-khong-phai-cho-ky`)
