...
All side-column nodes use fixed `w=160 h=64`. Same fill / stroke pattern: fill `rgba(79,93,117,0.06)`, stroke `#636b80`, stroke-width 1.
...
| Side-column stroke | `#636b80` | `rgba(245,245,245,0.30)` |
