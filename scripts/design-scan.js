// GENERATED by scripts/build-design-scan.mjs — do not edit by hand.
...
if (!window.__IMPECCABLE_LOADED__) { window.__IMPECCABLE_LOADED__ = true;
/**
...
;(function () {
  var P0 = new Set(["low-contrast","gray-on-color","text-overflow","broken-image","body-text-viewport-edge"]);
  var P1 = new Set(["gradient-text","side-tab","cream-palette","bounce-easing","image-hover-transform","nested-cards","icon-tile-stack","dark-glow","gpt-thin-border-wide-shadow","repeating-stripes-gradient","ai-color-palette"]);
  var DROP = new Set(["design-system-color","design-system-font","design-system-radius"]);
