...
- AC-6 (amendment 06/09/2026 — đọc-cũ): phương pháp mô tả dưới đây đã được thay bởi hồ sơ `thuoc-khai-mot-dang-do-mot-neo`; `git merge-base` và `check_lane` không còn tồn tại, vế lane nay so với bản tại mốc ký và vế tập-file neo vào khoảng đã giao, chiều đỏ vế hai chạy trên kho giả. Chữ ký và bằng chứng của hồ sơ này KHÔNG đổi; văn bản gốc giữ nguyên bên dưới để đọc lịch sử.
