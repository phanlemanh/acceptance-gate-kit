...
**CẮT ĐÔI 24/08 (owner chọn cửa (b) tại Cổng Bằng chứng vòng 5):** phần **Cổng Đáng có
cửa** (thẻ cổng thứ ba + chế độ ký của `/approve` + bàn giao `/start` + slot `g0`) đã TÁCH
sang hồ sơ riêng `_acceptance/cong-dang-co-cua/` — mã đã gỡ khỏi nhánh này, giữ nguyên vẹn
dưới dạng bản vá trong `discovery/` của hồ sơ đó. Lý do: năm vòng nghiệm thu cho thấy ba
mặt phẳng người trong một vòng là quá rộng để hội tụ; audit đoán «một lớp», thực tế là ba.
Vòng này giữ **trạng thái máy-đã-thông + bộ đọc + ô ngưỡng bốn trạng thái** — một câu
chuyện, một thước. AC-7/AC-8/AC-17 (và E7/E8/E17, RT7/RT8/RT17) theo phần tách.
...
cua-veto-sau-chu-ky da-giao da-nghi
lan-v-khong-phai-cho-ky da-giao da-nghi
release-2-18-0 da-giao da-nghi
KHAC-BIET-DOC-CU>>> -->
