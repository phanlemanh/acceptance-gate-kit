...
bypass_used: false
verified_commit: aee7174f40f848a90b2085014735a17149578c1b
human_signoff: 
---
...
- eval: E1
  ...
  verified_at: 2026-09-09T09:40:00Z
  output: |
...
- eval: E2
  run_id: minted-gom-duc-ket-2-10-0-E2-r2
  exit_code: 0
  baseline: n-a
...
- eval: E6
  run_id: minted-gom-duc-ket-2-10-0-E6-r2
  exit_code: 0
  baseline: n-a
...
- cmd: bash tests/scripts/run-tests.sh
  run_id: minted-gom-duc-ket-2-10-0-SUITE-bash_tests_scripts_run_tests_sh-r2
  exit_code: 0
  verified_at: 2026-09-09T09:40:00Z

- cmd: bash tests/hooks/run-tests.sh
  run_id: minted-gom-duc-ket-2-10-0-SUITE-bash_tests_hooks_run_tests_sh-r2
  exit_code: 0
  verified_at: 2026-09-09T09:40:00Z

- cmd: bash tests/plugins/run-tests.sh
  run_id: minted-gom-duc-ket-2-10-0-SUITE-bash_tests_plugins_run_tests_sh-r2
  exit_code: 0
  verified_at: 2026-09-09T09:40:00Z

- cmd: bash tests/workflows/run-tests.sh
  run_id: minted-gom-duc-ket-2-10-0-SUITE-bash_tests_workflows_run_tests_sh-r2
  exit_code: 0
  verified_at: 2026-09-09T09:40:00Z

- cmd: node scripts/product-map.mjs --root . --check
  run_id: minted-gom-duc-ket-2-10-0-SUITE-node_scripts_product_map_mjs_root_check-r2
  exit_code: 0
  verified_at: 2026-09-09T09:40:00Z
...
carried tu round truoc — baseline không đo lại round này (evals.yaml không đổi từ lần baseline cuối, hash khớp).

none — baseline không đo lại round này (carried từ round trước)
...
Round 2: mọi eval máy + suite đều PASS lại (13 eval + 5 suite, exit 0, baseline không đo lại) nhưng review lane xác nhận 6 phát hiện TRONG HỢP ĐỒNG mới (3 high, 2 medium, 1 low — xem review-findings.md, ánh xạ AC-2/AC-3/AC-6/AC-9/AC-10): dòng round-tally ghi verdict CŨ khi lane capture:provenance chết (feature-loop/workflows/acceptance-verify.js:1067), staleScope fail-open khi pathsOf đọc nhầm thân block scalar (lib/eval-yaml.cjs:76), làn review conventions bỏ sót file CODE từ round ≥2 (cùng file:491), nhánh return sớm của provenance lệch khuôn với blockedEarly (cùng file:1074/1063), và gate-card lệch nhãn Ngoài-N giữa khối hiển thị/dòng ký/khối việc-của-anh (scripts/gate-card.js:929) — cộng 5 phát hiện NGOÀI HỢP ĐỒNG (đo lường, đề xuất known-limits) mà 3/5 rơi vào _acceptance/gom-duc-ket-2-10-0/evals.yaml, file không bộ đo nào phủ — verdict REJECT, trả về implementation trước vòng verify kế.
