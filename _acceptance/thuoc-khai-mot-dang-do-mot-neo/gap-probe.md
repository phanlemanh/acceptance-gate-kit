...
> **BỔ CHÍNH 06/09/2026 (sau năm vòng S4).** Cột «Xử lý» ở trên ghi trạng thái tại thời điểm
> định đoạt, và hai dòng nay mô tả một bản cài KHÔNG còn: (a) ca «hai lượt một kết quả» đã bị gỡ
> hẳn cùng phép quét tĩnh thay nó — owner quyết thu phạm vi, xem NỢ CÓ TÊN trong Notes của
> contract; (b) vế lane so CÂY LÀM VIỆC chứ không so HEAD, và ca «chiều đỏ 1b» tồn tại chính để
> phân biệt hai phép ấy. Đọc contract Notes và review-findings.md trước khi mở lại việc này.
