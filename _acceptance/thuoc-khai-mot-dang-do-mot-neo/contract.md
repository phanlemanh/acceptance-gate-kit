...
- **GIỚI HẠN CÓ TÊN — fixture của đột biến «thêm cổng» viết tay đúng khuôn bên đọc.** Ba dòng
  bảng chèn vào là chuỗi markdown gõ tay, không rút từ bộ ghi thật. Nếu khuôn bảng đổi, đột
  biến ấy hoá no-op — chân `tiem()` bắt được ca chuỗi đích vắng, nhưng không bắt được ca dòng
  chèn vào sai khuôn.
