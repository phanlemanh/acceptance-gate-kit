...
| E17 | AC-16 | test | PASS |
| E18 | AC-17 | test | PASS |
| E15 | AC-15 | judgment | PASS |
| E16 | AC-15 | test | PASS |

## Evidence

- eval: E1
  run_id: minted-premerge-unjudged-pass-E1-r2
  exit_code: 0
  baseline: n-a
  ...
  output: |
    ...
    Results: 644 passed, 0 failed

- eval: E2
  run_id: minted-premerge-unjudged-pass-E2-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E2b
  run_id: minted-premerge-unjudged-pass-E2b-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E3
  run_id: minted-premerge-unjudged-pass-E3-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E4
  run_id: minted-premerge-unjudged-pass-E4-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E5
  run_id: minted-premerge-unjudged-pass-E5-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E6
  run_id: minted-premerge-unjudged-pass-E6-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E7
  run_id: minted-premerge-unjudged-pass-E7-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E8
  run_id: minted-premerge-unjudged-pass-E8-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E9
  run_id: minted-premerge-unjudged-pass-E9-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E10
  run_id: minted-premerge-unjudged-pass-E10-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E11
  run_id: minted-premerge-unjudged-pass-E11-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E12
  run_id: minted-premerge-unjudged-pass-E12-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E13
  run_id: minted-premerge-unjudged-pass-E13-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.plugins
  verified_at: 2026-07-28T09:00:00Z
  output: |
    PASS: P57 acceptance-init khong con noi approvers la informational (CA HAI harness)

    Results: all plugin tests passed

- eval: E14
  run_id: minted-premerge-unjudged-pass-E14-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E17
  run_id: minted-premerge-unjudged-pass-E17-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
- eval: E18
  run_id: minted-premerge-unjudged-pass-E18-r2
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.scripts
  verified_at: 2026-07-28T09:00:00Z
...
E1, E2, E2b, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E14, E17, E18, E16, E13
...
theo ĐƯỜNG DẪN. Thẻ Cổng 1 của chính nó: 13 AC trước và sau — không đổi.
...
### Re-pin lần 22 — 2026-08-07, do engine verify đổi ở vòng triage-key-normalize (chuẩn hoá path khoá ghép scope-triage + triage hỏng ra PENDING-JUDGMENT)
run_id: repin-20260807-triage-key-normalize-lane1
sha: 3f96b45349ea1981f6b4cb15c178d3f79bf15c6d · suites: 6 lệnh exit 0

### Re-pin lần 21 — 2026-08-07, do hợp nhất hai nhánh (workspace-reader-unification + triage-key-normalize) — engine đổi ở cả hai phía
run_id: repin-20260807-merge-wru-triage-lane1
sha: 7d6f42716f2c9b52892c6c341d31da3042ca8e3d · suites: 6 lệnh exit 0

### Re-pin lần 23 — 2026-08-07, do hợp nhất hai nhánh ac-line (eval-coverage-lint W7 + evidence-page parseAC một nguồn) + NEG_RE học từ vựng đối-chứng + changelog feature-loop v1.25/v1.26 — engine lint/trang-ký và manifest gói đổi
...
### Re-pin lần 37 — 2026-09-08, do chiến dịch ghim lại bằng làn eval sau ADR 0014 (owner 08/09, xử ngược không mốc)
run_id: repin-20260908T035246Z-95429
sha: 7d12ffad4010829598ded702b80a2ff8d12eb189 · suites: 5 lệnh exit 0 · evals: 14 eval máy exit 0

### Re-pin lần 38 — 2026-09-18, do chiến dịch ghim lại theo LÔ sau mốc 2.16.0 — lô lo-ac, 15 hồ sơ
run_id: repin-20260918T125024Z-93405
sha: b950f6643e253a691021612b5c5cabfe86cc4dda · suites: 5 lệnh exit 0 · evals: 14/14 eval máy đạt kỳ vọng

### Re-pin lần 39 — 2026-09-21, do chiến dịch ghim lại theo mốc 2.18.0
run_id: repin-20260921T175037Z-33397
sha: 41b949dec2245c147ff1460ba6e70e41e5fbb6df · suites: 5 lệnh exit 0 · evals: 14/14 eval máy đạt kỳ vọng · ngoài làn máy: E15 (E15 không khai paths)

### Re-pin lần 40 — 2026-09-22, do chiến dịch ghim lại theo mốc 2.18.1 (GUIDE §7.1)
run_id: repin-20260922T110053Z-46306
sha: ccabea22159944a10d5f768d5b67bd2b5d095d7c · suites: 5 lệnh exit 0 · evals: 14/14 eval máy đạt kỳ vọng · ngoài làn máy: E15 (E15 không khai paths)
