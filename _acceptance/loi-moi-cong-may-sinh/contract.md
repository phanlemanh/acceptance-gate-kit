...
- AC-7: Given fixture rút round-trip từ CHÍNH contract đã ký của release-2-5-0 và release-2-6-0, When dựng thẻ Cổng 1, Then các AC có chữ «không» ở GIỮA vế Then nằm cột «SẼ làm», và chỉ AC có vế Then MỞ ĐẦU bằng từ chối/chặn nằm cột «KHÔNG làm».
