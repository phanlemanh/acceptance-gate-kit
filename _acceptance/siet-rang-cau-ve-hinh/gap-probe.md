...
| P1 | evals+design E3/§5 | Không đường lấy stdout thật của P197 cho P199 → dễ trượt về fixture viết tay đúng khuôn bên đọc | Định dạng P197-M đổi thì rang lệch mà P199 xanh | rang.sh nhận `RANG_STDOUT_FILE`; răng của hồ sơ này ghi stdout thật rồi sed một dòng; cấm literal P197-M viết tay | **fixed:** AC-3 `RANG_STDOUT_FILE` + chiều đỏ từ stdout thật; chuyển toàn bộ kiểm răng ra khỏi P199 |
| P1 | contract AC-7/AC-8/Out-of-scope | P199 (suite vĩnh viễn) grep `_acceptance/**` + worktree hardcode 8d1e135 — mâu thuẫn nếp p194 và luật không hardcode | Hồ sơ lưu kho hoặc shallow clone → P199 đỏ oan; ai bỏ chân đó → mất đối chứng | Dời chân rang.sh + diffBase sang răng của hồ sơ này; P199 chỉ fixture + kiểm cấu trúc P90/P197 | **fixed:** AC-7 P199 không đụng `_acceptance/**`; AC-8 răng của hồ sơ này gánh; Out-of-scope viết lại |
