...
bypass_used: false
verified_commit: dc3b22e7f77b0b4734c8a75370e6a447a5977674
human_signoff:
---
...
- eval: E1
  run_id: minted-do-tin-tram-phan-loai-E1-r1
  exit_code: 0
  baseline: n-a
  verifier: config:executors.script.rang_triage_ma_may_duc
  verified_at: 2026-09-15T09:15:00+07:00
  output: |
    PASS: ma-may-duc doi chung duong: ban that ghep du ca ba du duong dan troi
...
- eval: E2
  run_id: minted-do-tin-tram-phan-loai-E2-r1
  exit_code: 0
  baseline: n-a
...
- eval: E3
  run_id: minted-do-tin-tram-phan-loai-E3-r1
  exit_code: 0
  baseline: n-a
  verifier: config:executors.script.rang_triage_ma_la
  verified_at: 2026-09-15T09:15:00+07:00
  output: |
    PASS: ma-la ban that: dong t99 bi bo, co log goi ten, ca ba van ghep
    PASS: ma-la mutant bo luoi ma-la -> dong la khong duoc goi ten (rang song)
    PASS: dong mang ma la la dong THUA — bi bo, co dong chan doan goi ten no, va khong phat hien nao mat phan loai vi no

- eval: E4
  run_id: minted-do-tin-tram-phan-loai-E4-r1
  exit_code: 0
  baseline: n-a
...
- eval: E5
  run_id: minted-do-tin-tram-phan-loai-E5-r1
  exit_code: 0
  baseline: n-a
...
- eval: E6a
  run_id: minted-do-tin-tram-phan-loai-E6a-r1
  exit_code: 0
  baseline: n-a
...
- eval: E6b
  run_id: minted-do-tin-tram-phan-loai-E6b-r1
  exit_code: 0
  baseline: n-a
...
- eval: E7a
  run_id: minted-do-tin-tram-phan-loai-E7a-r1
  exit_code: 0
  baseline: n-a
...
- eval: E7b
  run_id: minted-do-tin-tram-phan-loai-E7b-r1
  exit_code: 0
  baseline: n-a
...
- eval: E8a
  run_id: minted-do-tin-tram-phan-loai-E8a-r1
  exit_code: 0
  baseline: n-a
...
- eval: E8b
  run_id: minted-do-tin-tram-phan-loai-E8b-r1
  exit_code: 0
  baseline: n-a
...
- eval: E8c
  run_id: minted-do-tin-tram-phan-loai-E8c-r1
  exit_code: 0
  baseline: n-a
...
- eval: E9
  run_id: minted-do-tin-tram-phan-loai-E9-r1
  exit_code: 0
  baseline: n-a
...
- eval: E10
  run_id: minted-do-tin-tram-phan-loai-E10-r1
  exit_code: 0
  baseline: n-a
...
- eval: E11
  run_id: minted-do-tin-tram-phan-loai-E11-r1
  exit_code: 0
  baseline: green
...
- eval: E12
  run_id: minted-do-tin-tram-phan-loai-E12-r1
  exit_code: 0
  baseline: green
...
- cmd: bash tests/scripts/run-tests.sh
  run_id: minted-do-tin-tram-phan-loai-SUITE-bash_tests_scripts_run_tests_sh-r1
  exit_code: 0
  verified_at: 2026-09-15T09:15:00+07:00

- cmd: bash tests/hooks/run-tests.sh
  run_id: minted-do-tin-tram-phan-loai-SUITE-bash_tests_hooks_run_tests_sh-r1
  exit_code: 0
  verified_at: 2026-09-15T09:15:00+07:00

- cmd: node scripts/product-map.mjs --root . --check
  run_id: minted-do-tin-tram-phan-loai-SUITE-node_scripts_product_map_mjs_root_check-r1
  exit_code: 0
  verified_at: 2026-09-15T09:15:00+07:00
