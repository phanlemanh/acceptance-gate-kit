...
- eval: E9
  ...
  proposal: PASS
  carried_from_round: 3
  note: panel giu nguyen tu round 3 — inputs khong doi (hash khop), khong cham lai; rationale xem round 3.
  votes:
...
- eval: E16
  run_id: minted-gap-probe-presence-hook-E16-r4
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.plugins
  verified_at: 2026-07-26T10:30:00Z
  output: |
...
- eval: E20
  run_id: minted-gap-probe-presence-hook-E20-r4
  exit_code: 0
  baseline: n-a
  verifier: config:executors.test.plugins
  verified_at: 2026-07-26T10:30:00Z
