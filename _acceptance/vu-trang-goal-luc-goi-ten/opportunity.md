...
gọi người = 4 cổng thiết kế + ≥6 ngoài thiết kế; ≥4 trong số đó là *máy giao
tiến trình nền rồi khi nó xong thì báo cáo và ngừng nói* (S3 ×1, S4 ×2, một lần
khai «đang chạy» sai) — đúng ca `/goal` đỡ được, mà `/goal` chưa bật vì luật
«luôn in /goal» trượt (findings 02/09). Hồ sơ mốc 2.7.0 gọi tên đây là chỗ cắt
của cửa sổ kế.
...
2. **Điểm in dời về mọi lượt người đứng trước một đoạn máy:** lúc «làm» (S0,
   TRƯỚC khi S1 chạy), Cổng Phạm vi (khi duyệt), Gate 1.5 (T3). Vòng có cổng
   giữa cần vũ trang lại ở mỗi cổng — vì khuôn goal cố ý coi «máy đang chờ
   người» là hoàn thành; làn V T2 chỉ cần lần đầu. Đây là sửa chữ skill + GUIDE.
...
|---|---|---|---|---|
| 1 | Khuôn goal hiện hành (đích verified · «chờ input người» = hoàn thành · trần 15 lượt) vũ trang lúc «làm» vẫn hoạt động đúng: dừng ở Cổng 1 khi không làn V, chạy tiếp khi làn V | goal kết sớm hoặc spin ở cổng | phiên con `claude -p` với goal + hồ sơ giả ở hai trạng thái, đọc transcript | Chưa thử — khai Known limits nếu không đo được trong vòng |
...
· findings 26/07 (feature-loop không tự loop) · hình v28-01.
