...
bypass_used: false
verified_commit: 4850498e4288c310b3cc1667b04e00a6b5cad35c
human_signoff:
---
...
- eval: E1
  run_id: minted-cua-veto-sau-chu-ky-E1-r5
  exit_code: 0
  baseline: n-a
  verifier: config:executors.script.cvsck_note_da_ky
  verified_at: 2026-09-12T15:20:00Z
  output: |
...
- eval: E2
  run_id: minted-cua-veto-sau-chu-ky-E2-r5
  exit_code: 0
  baseline: n-a
...
- eval: E3
  run_id: minted-cua-veto-sau-chu-ky-E3-r5
  exit_code: 0
  baseline: n-a
...
- eval: E4
  run_id: minted-cua-veto-sau-chu-ky-E4-r5
  exit_code: 0
  baseline: n-a
...
- eval: E5
  run_id: minted-cua-veto-sau-chu-ky-E5-r5
  exit_code: 0
  baseline: n-a
...
- eval: E6
  run_id: minted-cua-veto-sau-chu-ky-E6-r5
  exit_code: 0
  baseline: n-a
...
- eval: E7
  run_id: minted-cua-veto-sau-chu-ky-E7-r5
  exit_code: 0
  baseline: n-a
...
- eval: E8
  run_id: minted-cua-veto-sau-chu-ky-E8-r5
  exit_code: 0
  baseline: n-a
...
- eval: E9
  run_id: minted-cua-veto-sau-chu-ky-E9-r5
  exit_code: 0
  baseline: green
...
- eval: E10
  run_id: minted-cua-veto-sau-chu-ky-E10-r5
  exit_code: 0
  baseline: n-a
...
- eval: E11
  run_id: minted-cua-veto-sau-chu-ky-E11-r5
  exit_code: 0
  baseline: n-a
...
- eval: E12
  run_id: minted-cua-veto-sau-chu-ky-E12-r5
  exit_code: 0
  baseline: n-a
...
- cmd: bash tests/scripts/run-tests.sh
  run_id: minted-cua-veto-sau-chu-ky-SUITE-bash_tests_scripts_run_tests_sh-r5
  exit_code: 0
  verified_at: 2026-09-12T15:20:00Z

- cmd: bash tests/hooks/run-tests.sh
  run_id: minted-cua-veto-sau-chu-ky-SUITE-bash_tests_hooks_run_tests_sh-r5
  exit_code: 0
  verified_at: 2026-09-12T15:20:00Z

- cmd: bash -c 'set -o pipefail; bash tests/plugins/run-tests.sh 2>&1 | grep -E "FAIL|^Results:" | tail -n 40'
  run_id: minted-cua-veto-sau-chu-ky-SUITE-bash_tests_plugins_run_tests_sh_2_1_grep-r5
  exit_code: 1
  verified_at: 2026-09-12T15:20:00Z

- cmd: bash tests/workflows/run-tests.sh
  run_id: minted-cua-veto-sau-chu-ky-SUITE-bash_tests_workflows_run_tests_sh-r5
  exit_code: 0
  verified_at: 2026-09-12T15:20:00Z

- cmd: node scripts/product-map.mjs --root . --check
  run_id: minted-cua-veto-sau-chu-ky-SUITE-node_scripts_product_map_mjs_root_check-r5
  exit_code: 0
  verified_at: 2026-09-12T15:20:00Z
...
E9 (cmd: `node tests/scripts/additive-only.test.mjs`, baseline: green) — pass trên CẢ HEAD lẫn diffBase, tức DV5 xanh cả trước và sau vòng này nên không tự phân biệt được feature. Xem review-findings.md: ca "DV5u-mutant" bên trong bài test này chấm trên bản chép lại thân luật DV5u thay vì gọi qua chính luật thật, nên màu xanh-cả-hai-phía ở đây chưa chứng minh được feature — cần hoặc rút hàm thuần dùng chung giữa DV5u thật và ca mutant, hoặc xác nhận rõ đây là regression-guard có chủ ý.
