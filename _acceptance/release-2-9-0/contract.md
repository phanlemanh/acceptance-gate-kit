...
- known-limits (gộp lần 2): làn ghim lại lần 1 (`repin-20260907-rel290-1`, suite-only, ts 15:00Z — sau mốc 12:00Z của luật mới nhưng TRƯỚC giờ luật lên `main` 15:27Z) bị luật mới xử ngược; section cite nó đã rút để phá bế tắc vòng tròn (suite đỏ trên chính hồ sơ → làn không ghi), dòng run-log giữ nguyên làm sử liệu; làn eval thay thế (sổ 8015). Phát hiện P1 cho `0b5c5b37`: hồ sơ có làn suite-only sau 12:00Z không tự ghim lại được bằng `repin-lane.mjs`.
